...
app.post('/api/save-content', authenticate, async (req, res) => { return res.status(403).json({ error: 'MODE DEMO : Les modifications sont d�sactiv�es pour la s�curit� du portfolio.' }); try {
